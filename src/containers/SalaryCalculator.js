...
const SalaryCalculator = () => {
  ...
  const calculate = () => {
    ...
    let net_salary = basicSalary - (employee_epf + employer_epf + employer_etf);
      ...
      <div className="pt-16">
        <div className="grid grid-cols-6 gap-5 sm:gap-10">
          ...
          <div className="col-span-6">
            <button
              onClick={calculate}
              className="bg-sky-400 block w-full py-3 rounded-none"
            >
              Calculate
            </button>
          </div>
  ...
  return (
    <>
      <Calculator
        ...
        description="Calculate EPF and ETF easily be providing details related to your salary."
      />
        ...
        {loading ? (
          ...
          <div className="lg:h-96">
            <div className="border-b border-slate-300 my-4">
              <p className="text-zinc-900 font-bold text-lg text-center underline decoration-zinc-400 decoration-2">
                Net Salary
              </p>
              <p className="text-zinc-900 font-extrabold text-2xl text-center mt-2">
            ...
            <div className="border-b border-slate-300 my-4">
              ...
              <div className="flex items-center justify-between mt-4">
                <p className="text-zinc-900 font-extrabold text-lg text-center mt-2">
                  EPF (8%)
                </p>
                <p className="text-zinc-900 font-extrabold text-lg text-center mt-2">
                  {numberWithCommas(employeeEPF)}
                </p>
              </div>
            </div>
            <div className="border-b border-slate-300 my-4">
